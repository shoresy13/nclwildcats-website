        ...
        <MainLayout>
            ...
            >
                <div className="relative bottom-30 sm:bottom-32 md:bottom-45 flex flex-col justify-center items-center text-center px-4 sm:px-6">
                    <h1 className="font-extrabold tracking-widest whitespace-nowrap text-[clamp(2rem,6vw,4rem)] sm:text-[clamp(2.5rem,5vw,5rem)] md:text-7xl">
                        NEWCASTLE WILDCATS
                    </h1>
                ...
                <div className="relative -bottom-40 sm:-bottom-45 md:-bottom-50 mt-10 flex flex-col sm:flex-row gap-4 sm:gap-15">
                    <Button
                        text="Join Now"
